...
<html>
  ...
  <body onload="check('${good.class_id}','${good.cate_id }')">
    ...
    <div id="content">
    <form action="../webpage/good?action=update2" method="post" enctype="multipart/form-data">
       <table align="center">
       		<tr>
           ...
           <tr>
            ...
            <td>
            	<select name="describe">
            		<option value="1" <c:if test="${good.describe==1}">selected="selected"</c:if>>疯狂抢购</option>
            		<option value="0" <c:if test="${good.describe==0}">selected="selected"</c:if>>普通</option>
            	</select>
            </td>
           </tr>
           <tr>
            ...
            <td>
            	<select name="good_type">
            		<option value="1" <c:if test="${good.good_type==1}">selected="selected"</c:if>>全新</option>
            		<option value="0" <c:if test="${good.good_type==0}">selected="selected"</c:if>>普通</option>
            	</select>
            </td>
           </tr>
           <tr>
