...
<html>
  ...
  <body>
    ...
    <div id="content">
    <form action="../webpage/order?action=update2" method="post">
       <table align="center">
       		<tr>
           	<td align="right" width="100px">订单编号：</td>
            <td width="450px"><input type="hidden" name="page" value="${page}"><input type="text" name="order_id" value="${order.order_id }" readonly="readonly"/></td>
			<td></td>            
           </tr>
           <tr>
           		<td align="right">订购人姓名：</td>
           ...
           <tr>
            ...
            <td>
            	<select name="order_status">
            		...
            		<option value="4" <c:if test="${order.order_status==4}">selected="selected"</c:if>>已收货</option>
            		<option value="5" <c:if test="${order.order_status==5}">selected="selected"</c:if>>交易完成</option>
            	</select>
            </td>
           </tr>
           <tr>
